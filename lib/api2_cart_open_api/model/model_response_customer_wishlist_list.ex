...
defmodule API2CartOpenAPI.Model.ModelResponseCustomerWishlistList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => API2CartOpenAPI.Model.ResponseCustomerWishlistListResult.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, API2CartOpenAPI.Model.ResponseCustomerWishlistListResult)
  end
end
