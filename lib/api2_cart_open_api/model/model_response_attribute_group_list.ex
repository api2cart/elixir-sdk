...
defmodule API2CartOpenAPI.Model.ModelResponseAttributeGroupList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => API2CartOpenAPI.Model.ResponseAttributeGroupListResult.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, API2CartOpenAPI.Model.ResponseAttributeGroupListResult)
  end
end
