...
defmodule API2CartOpenAPI.Model.ModelResponseCartGiftCardList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => API2CartOpenAPI.Model.ResponseCartGiftcardListResult.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, API2CartOpenAPI.Model.ResponseCartGiftcardListResult)
  end
end
