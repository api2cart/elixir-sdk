...
defmodule API2CartOpenAPI.Model.ModelResponseCustomerList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => API2CartOpenAPI.Model.ResponseCustomerListResult.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, API2CartOpenAPI.Model.ResponseCustomerListResult)
  end
end
