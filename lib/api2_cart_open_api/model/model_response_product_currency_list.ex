...
defmodule API2CartOpenAPI.Model.ModelResponseProductCurrencyList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => API2CartOpenAPI.Model.ResponseProductCurrencyListResult.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, API2CartOpenAPI.Model.ResponseProductCurrencyListResult)
  end
end
