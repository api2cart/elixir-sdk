...
defmodule API2CartOpenAPI.Model.ModelResponseProductChildItemList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => API2CartOpenAPI.Model.ResponseProductChildItemListResult.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, API2CartOpenAPI.Model.ResponseProductChildItemListResult)
  end
end
