...
defmodule API2CartOpenAPI.Model.ModelResponseOrderShipmentList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => API2CartOpenAPI.Model.ResponseOrderShipmentListResult.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, API2CartOpenAPI.Model.ResponseOrderShipmentListResult)
  end
end
