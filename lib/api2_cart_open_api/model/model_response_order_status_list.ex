...
defmodule API2CartOpenAPI.Model.ModelResponseOrderStatusList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => API2CartOpenAPI.Model.ResponseOrderStatusListResult.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, API2CartOpenAPI.Model.ResponseOrderStatusListResult)
  end
end
