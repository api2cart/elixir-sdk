...
defmodule API2CartOpenAPI.Model.ModelResponseProductAttributeList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => API2CartOpenAPI.Model.ResponseProductAttributeListResult.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, API2CartOpenAPI.Model.ResponseProductAttributeListResult)
  end
end
