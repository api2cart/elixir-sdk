...
defmodule API2CartOpenAPI.Model.AccountCartAdd do
  ...
  defstruct [
    ...
    :zid_authorization,
    :zid_refresh_token,
    :jumpseller_client_id,
    :jumpseller_client_secret,
    :jumpseller_refresh_token,
    :jumpseller_login,
  ...
  @type t :: %__MODULE__{
    ...
    :americommerce_app_id => String.t | nil,
    :americommerce_app_secret => String.t | nil,
    :americommerce_access_token => String.t | nil,
    :americommerce_refresh_token => String.t | nil,
    ...
    :nopcommerce_token => String.t | nil,
    :nopcommerce_secret => String.t | nil,
    ...
    :walmart_refresh_token => String.t | nil,
    :walmart_seller_id => String.t | nil,
    ...
    :shopify_client_id => String.t | nil,
    ...
    :jumpseller_client_id => String.t | nil,
    :jumpseller_client_secret => String.t | nil,
    :jumpseller_refresh_token => String.t | nil,
    :jumpseller_login => String.t | nil,
    :jumpseller_authtoken => String.t | nil,
