...
defmodule API2CartOpenAPI.Model.ModelResponseCustomerGroupList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => API2CartOpenAPI.Model.ResponseCustomerGroupListResult.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, API2CartOpenAPI.Model.ResponseCustomerGroupListResult)
  end
end
