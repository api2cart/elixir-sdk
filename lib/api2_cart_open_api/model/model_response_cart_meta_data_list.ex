...
defmodule API2CartOpenAPI.Model.ModelResponseCartMetaDataList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :result => API2CartOpenAPI.Model.ResponseCartMetaDataListResult.t | nil,
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:result, :struct, API2CartOpenAPI.Model.ResponseCartMetaDataListResult)
  end
end
