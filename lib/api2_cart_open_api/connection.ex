...
defmodule API2CartOpenAPI.Connection do
  @moduledoc """
  Handle Tesla connections for API2CartOpenAPI.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:api2_cart_open_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - API2CartOpenAPI 1.0.0 - elixir"
        )
      )
