...
defmodule API2CartOpenAPI.Api.Account do
  ...
  - `opts` (keyword): Optional parameters
    ...
    - `:nopcommerce_secret` (String.t): nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it.
